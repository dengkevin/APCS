...
public class JMCh12Exercises
{
    ...
    public boolean[] prob2abcdTrueFalse()
    {
        ...
        /*
         * (a) This is false because the array contains 100 elements, not 101.
         * (b) This is true because an array's subscript can have all int value
         * from 0 up to the length of the array - 1. Thus, Java syntax allows
         * programmars to use the int data type to represent an index of an
         * array.
         * (c) This is true because when the program is running, it verifies
         * whether all array indexes fall into a valid range otherwise it will
         * throw a index out of bounds exception.
         * (d) You can get the length of a one-dimensional array object, but
         * it is through the syntax .length, and this is not a method, it is a
         * public field.
         */
    }
    ...
    {
        Character[] rps = {'r', 'r', 'r', 'p', 'p', 'p', 'p', 'p', 
            's', 's', 's', 's', 's', 's',};
        int random = (int)(Math.random() * rps.length);
        return rps[random];
    }
    ...
    public String whatDoesMysteryCountCount()
    {
        ...
        String answer = mCount + " how many zeros in a row until the index of "
            + "the array contains a nonzero integer."; 
    ...
    public boolean[] prob11abcdeTrueFalse()
    {
        ...
        /*
         * a) An ArrayList can hold multiple references to the same object
         * b) This is true. An ArrayList just holds the object, and an object
         * is not restricted to only being in one ArrayList.
         * c) ArrayList's remove method only removes the object at that given
         * index. The Java Garbage collector actually destroys objects, which we
         * cannot control.
         * d) The add method creates a reference of the object and adds it to
         * the ArrayList.
         * e) Two variables can refer to the same ArrayList as a reference.
         */
    }
    ...
    public void removeMin( ArrayList<Integer> list )
    {
        if (!list.isEmpty())
        {
            ...
            {
                int compareValue = min.compareTo(list.get(i));
