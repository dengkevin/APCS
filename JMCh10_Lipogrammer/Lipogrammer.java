...
public class Lipogrammer extends JFrame implements ActionListener
{
  ...
  public Lipogrammer()
  {
    ...
    original.setText("a lipogram (from Greek lipagrammatos, 'missing letter') "
        + "is a kind of writing with constraints or word game consisting of"
        + "writing paragraphs or longer works in which a particular letter or"
        + "group of letters is missing, usually a common vowel, the most common"
        + " in English being e.");
    refresh();
  }
